...
from gail_chatbot.light.encdec_lm import EncoderDecoderSimple
from gail_chatbot.light.light_chatbot_base import LightChatbotBase


class LightEncoderDecoderFineTune(LightChatbotBase):
    def __init__(self, opt: Dict[str, Any], shared: Dict[str, Any] = None):
        super().__init__(opt, shared)

        self.id = "LightEncoderDecoderFineTune"
    ...
    def _construct_model(self, path):
        self.generator = EncoderDecoderSimple(special_tokens=self.ctx_tokens).train()
